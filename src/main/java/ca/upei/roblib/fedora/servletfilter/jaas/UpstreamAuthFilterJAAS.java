...
/**
 * Adjusted copypasta of org.fcrepo.server.security.jaas.AuthFilterJAAS.
 *
 * Primarily, adjust the visibility of "private" member to "protected", to
...
implements Filter {
    ...
    protected static final String SESSION_SUBJECT_KEY =
            "javax.security.auth.subject";

    protected static final String JAAS_CONFIG_KEY =
    ...
    protected static final String FEDORA_ATTRIBUTES_KEY =
            "FEDORA_AUX_SUBJECT_ATTRIBUTES";

    protected String jaasConfigName = null;

    protected final FilterConfigBean filterConfigBean = new FilterConfigBean();

    protected FilterConfig filterConfig = filterConfigBean;

    protected Set<String> userClassNames = null;

    protected Set<String> roleClassNames = null;

    protected Set<String> roleAttributeNames = null;

    protected boolean authnAPIA = true;
     ...
     */
    protected Set<String> getUserRoles(Subject subject) {
     ...
     */
    protected void addRolesToSubject(Subject subject, Set<String> userRoles) {
        if (userRoles == null) {
